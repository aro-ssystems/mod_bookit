...
$string['checklist_active_help'] = 'Uncheck to hide this resource from the checklist.';
...
$string['checklist_sortorder'] = 'Sort order';
$string['checklist_sortorder_help'] = 'Display order in the resource checklist (independent from resource overview).';
...
$string['event_checklist:booked_amount'] = 'Booked';
$string['event_checklist:confirmed'] = 'confirmed';
$string['event_checklist:progress'] = 'Resource Status Progress';
$string['event_checklist_heading'] = 'Resource Checklist for Event: {$a}';
$string['event_checklist_no_resources'] = 'No resources are assigned to this event.';
$string['event_checklist_title'] = 'Event Resource Checklist';
$string['event_checklist_view:done'] = 'done';
$string['event_checklist_view:progress'] = 'Checklist Progress';
$string['event_checklist_view_heading'] = 'Checklist for Event: {$a}';
$string['event_checklist_view_no_items'] = 'No checklist items are available for this event.';
$string['event_checklist_view_title'] = 'Event Checklist';
...
$string['resource_amount_must_be_positive'] = 'Amount must be a positive number.';
$string['resource_category_not_found'] = 'The selected resource category was not found.';
$string['resource_category_required'] = 'Resource category is required.';
$string['resource_name_required'] = 'Resource name is required.';
$string['resource_status'] = 'Resource Status';
$string['resource_status_confirmed'] = 'Confirmed';
...
$string['resources:checklist'] = 'Resource Checklist';
$string['resources:checklist_empty'] = 'The resource checklist is empty. Generate checklist entries from existing resources.';
$string['resources:checklist_generated'] = '{$a} checklist items generated successfully.';
