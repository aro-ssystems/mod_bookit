...
$string['resources:filter_no_resources'] = 'Add a category and resources first to use the room filter.';
...
$string['resources:settings_active_help'] = 'Uncheck to hide this resource from the checklist.';
...
$string['settings_active'] = 'Active in checklist settings';
