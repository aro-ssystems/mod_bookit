...
$string['resources:checklist_active_help'] = 'Uncheck to hide this resource from the checklist.';
...
$string['resources:checklist_sortorder_help'] = 'Display order in the resource checklist (independent from resource overview).';
