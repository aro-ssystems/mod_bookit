...
$string['checklist_active_help'] = 'Deaktivieren, um diese Ressource in der Checkliste zu verbergen.';
...
$string['checklist_sortorder'] = 'Sortierreihenfolge';
$string['checklist_sortorder_help'] = 'Anzeigereihenfolge in der Ressourcen-Checkliste (unabhängig von der Ressourcenübersicht).';
...
$string['event_checklist:booked_amount'] = 'Gebucht';
$string['event_checklist:confirmed'] = 'bestätigt';
$string['event_checklist:progress'] = 'Ressourcenstatus Fortschritt';
$string['event_checklist_heading'] = 'Ressourcen-Checkliste für Veranstaltung: {$a}';
$string['event_checklist_no_resources'] = 'Dieser Veranstaltung sind keine Ressourcen zugewiesen.';
$string['event_checklist_title'] = 'Veranstaltungs-Ressourcen-Checkliste';
$string['event_checklist_view:done'] = 'erledigt';
$string['event_checklist_view:progress'] = 'Checklisten-Fortschritt';
$string['event_checklist_view_heading'] = 'Checkliste für Veranstaltung: {$a}';
$string['event_checklist_view_no_items'] = 'Für diese Veranstaltung sind keine Checklisten-Einträge verfügbar.';
$string['event_checklist_view_title'] = 'Veranstaltungs-Checkliste';
...
$string['resource_amount_must_be_positive'] = 'Die Anzahl muss eine positive Zahl sein.';
$string['resource_category_not_found'] = 'Die ausgewählte Ressourcenkategorie wurde nicht gefunden.';
$string['resource_category_required'] = 'Ressourcenkategorie ist erforderlich.';
$string['resource_name_required'] = 'Ressourcenname ist erforderlich.';
$string['resource_status'] = 'Ressourcenstatus';
$string['resource_status_confirmed'] = 'Bestätigt';
...
$string['resources:checklist'] = 'Ressourcen-Checkliste';
$string['resources:checklist_empty'] = 'Die Ressourcen-Checkliste ist leer. Generieren Sie Checklisteneinträge aus vorhandenen Ressourcen.';
$string['resources:checklist_generated'] = '{$a} Checklisteneinträge erfolgreich generiert.';
...
$string['resources:rooms_help'] = 'Wählen Sie Räume aus, in denen diese Ressource verfügbar ist. Leer lassen, wenn die Ressource in allen Räumen verfügbar ist.';
$string['resources:view_checklist'] = 'Checkliste anzeigen';
$string['resources_checklist'] = 'Ressourcen-Checkliste';
